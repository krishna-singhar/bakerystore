            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="restaurants.php">Choose cuisine</a></li>
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-3">
                        <div class="sidebar-wrap">
                           <div class="widget clearfix">
                            ...
                            <div class="widget-body">
                                <ul class="tags">
                                    <li> <a href="dishes.php?res_id=65" class="tag">
                                    Cake
                                 </a> </li>
                                    <li> <a href="#" class="tag">
                                    Bread
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <h3>Frosted Fox - The Best Online Bakery Store</h3>
                                <p>Got Hungry? Get the food you want, from the Bakeries you love, delivered at blinking speed.
