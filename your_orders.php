												...
												<tr>	
														 <td data-column="Item"> <?php echo $row['title']; ?></td>
														  ...
														  <td data-column="Date"> <?php echo $row['date']; ?></td>
														   <td data-column="Action"> <a href="delete_orders.php?order_del=<?php echo $row['o_id'];
                                                           ?>" onclick="return confirm('Are you sure you want to cancel your order?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10 delbtn" id="<?php echo $row['o_id'];?>"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
															</td>
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Frosted Fox - The Best Online Bakery Store</h3>
